...
namespace HarmonyLib
{
	...
	public class PatchProcessor
	{
		...
		/// <summary>Replaces the pending prefix; installed patches are unchanged</summary>
		...
		/// <summary>Replaces the pending postfix; installed patches are unchanged</summary>
		...
		/// <summary>Replaces the pending transpiler; installed patches are unchanged</summary>
		...
		/// <summary>Replaces the pending finalizer; installed patches are unchanged</summary>
		...
		/// <summary>Appends a pending inner prefix</summary>
		/// <param name="innerPrefix">The callback with an explicit target or <see cref="HarmonyInfix"/> declaration</param>
		/// <returns>A <see cref="PatchProcessor"/> for chaining calls</returns>
		///
		...
		/// <summary>Appends a pending inner prefix</summary>
		/// <param name="fixMethod">The callback with a <see cref="HarmonyInfix"/> target</param>
		/// <returns>A <see cref="PatchProcessor"/> for chaining calls</returns>
		///
		...
		/// <summary>Appends a pending inner postfix</summary>
		/// <param name="innerPostfix">The callback with an explicit target or <see cref="HarmonyInfix"/> declaration</param>
		/// <returns>A <see cref="PatchProcessor"/> for chaining calls</returns>
		///
		...
		/// <summary>Appends a pending inner finalizer</summary>
		/// <param name="innerFinalizer">The callback with an explicit target or <see cref="HarmonyInfix"/> declaration</param>
		...
		/// <remarks>Retains the configuration. Repeated calls add registrations; they do not replace earlier installations.</remarks>
