...
namespace HarmonyLib
{
	public static class Code
	{
		...
		public static Stind_Ref_ Stind_Ref => new Stind_Ref_() { opcode = OpCodes.Stind_Ref };
		...
		public static Isinst_ Isinst => new Isinst_() { opcode = OpCodes.Isinst };
		public class Isinst_ : CodeMatch { public Isinst_ this[object operand = null, string name = null] => (Isinst_)Set(operand, name); }
		public static Conv_R_Un_ Conv_R_Un => new Conv_R_Un_() { opcode = OpCodes.Conv_R_Un };
		...
		public static Conv_Ovf_I2_Un_ Conv_Ovf_I2_Un => new Conv_Ovf_I2_Un_() { opcode = OpCodes.Conv_Ovf_I2_Un };
		...
		public static Conv_Ovf_I4_Un_ Conv_Ovf_I4_Un => new Conv_Ovf_I4_Un_() { opcode = OpCodes.Conv_Ovf_I4_Un };
		...
		public static Conv_Ovf_I8_Un_ Conv_Ovf_I8_Un => new Conv_Ovf_I8_Un_() { opcode = OpCodes.Conv_Ovf_I8_Un };
		...
		public static Conv_Ovf_U1_Un_ Conv_Ovf_U1_Un => new Conv_Ovf_U1_Un_() { opcode = OpCodes.Conv_Ovf_U1_Un };
		...
		public static Conv_Ovf_U2_Un_ Conv_Ovf_U2_Un => new Conv_Ovf_U2_Un_() { opcode = OpCodes.Conv_Ovf_U2_Un };
		...
		public static Conv_Ovf_U4_Un_ Conv_Ovf_U4_Un => new Conv_Ovf_U4_Un_() { opcode = OpCodes.Conv_Ovf_U4_Un };
		...
		public static Conv_Ovf_U8_Un_ Conv_Ovf_U8_Un => new Conv_Ovf_U8_Un_() { opcode = OpCodes.Conv_Ovf_U8_Un };
		...
		public static Conv_Ovf_I_Un_ Conv_Ovf_I_Un => new Conv_Ovf_I_Un_() { opcode = OpCodes.Conv_Ovf_I_Un };
		...
		public static Conv_Ovf_U_Un_ Conv_Ovf_U_Un => new Conv_Ovf_U_Un_() { opcode = OpCodes.Conv_Ovf_U_Un };
		...
		public static Ldelem_U1_ Ldelem_U1 => new Ldelem_U1_() { opcode = OpCodes.Ldelem_U1 };
		...
		public static Ldelem_I2_ Ldelem_I2 => new Ldelem_I2_() { opcode = OpCodes.Ldelem_I2 };
		...
		public static Ldelem_U2_ Ldelem_U2 => new Ldelem_U2_() { opcode = OpCodes.Ldelem_U2 };
		...
		public static Ldelem_I4_ Ldelem_I4 => new Ldelem_I4_() { opcode = OpCodes.Ldelem_I4 };
		...
		public static Ldelem_U4_ Ldelem_U4 => new Ldelem_U4_() { opcode = OpCodes.Ldelem_U4 };
		...
		public static Ldelem_I8_ Ldelem_I8 => new Ldelem_I8_() { opcode = OpCodes.Ldelem_I8 };
		...
		public static Ldelem_I_ Ldelem_I => new Ldelem_I_() { opcode = OpCodes.Ldelem_I };
		public class Ldelem_I_ : CodeMatch { public Ldelem_I_ this[object operand = null, string name = null] => (Ldelem_I_)Set(operand, name); }
		public static Ldelem_R4_ Ldelem_R4 => new Ldelem_R4_() { opcode = OpCodes.Ldelem_R4 };
		...
		public static Ldelem_R8_ Ldelem_R8 => new Ldelem_R8_() { opcode = OpCodes.Ldelem_R8 };
		...
		public static Ldelem_Ref_ Ldelem_Ref => new Ldelem_Ref_() { opcode = OpCodes.Ldelem_Ref };
		...
		public static Stelem_I_ Stelem_I => new Stelem_I_() { opcode = OpCodes.Stelem_I };
		public class Stelem_I_ : CodeMatch { public Stelem_I_ this[object operand = null, string name = null] => (Stelem_I_)Set(operand, name); }
		public static Stelem_I1_ Stelem_I1 => new Stelem_I1_() { opcode = OpCodes.Stelem_I1 };
		...
		public static Stelem_I2_ Stelem_I2 => new Stelem_I2_() { opcode = OpCodes.Stelem_I2 };
		...
		public static Stelem_I4_ Stelem_I4 => new Stelem_I4_() { opcode = OpCodes.Stelem_I4 };
		...
		public static Stelem_I8_ Stelem_I8 => new Stelem_I8_() { opcode = OpCodes.Stelem_I8 };
		...
		public static Stelem_R4_ Stelem_R4 => new Stelem_R4_() { opcode = OpCodes.Stelem_R4 };
		...
		public static Stelem_R8_ Stelem_R8 => new Stelem_R8_() { opcode = OpCodes.Stelem_R8 };
		...
		public static Stelem_Ref_ Stelem_Ref => new Stelem_Ref_() { opcode = OpCodes.Stelem_Ref };
		...
		public static Conv_Ovf_I1_ Conv_Ovf_I1 => new Conv_Ovf_I1_() { opcode = OpCodes.Conv_Ovf_I1 };
		...
		public static Conv_Ovf_U1_ Conv_Ovf_U1 => new Conv_Ovf_U1_() { opcode = OpCodes.Conv_Ovf_U1 };
		...
		public static Conv_Ovf_I2_ Conv_Ovf_I2 => new Conv_Ovf_I2_() { opcode = OpCodes.Conv_Ovf_I2 };
		...
		public static Conv_Ovf_U2_ Conv_Ovf_U2 => new Conv_Ovf_U2_() { opcode = OpCodes.Conv_Ovf_U2 };
		...
		public static Conv_Ovf_I4_ Conv_Ovf_I4 => new Conv_Ovf_I4_() { opcode = OpCodes.Conv_Ovf_I4 };
		...
		public static Conv_Ovf_U4_ Conv_Ovf_U4 => new Conv_Ovf_U4_() { opcode = OpCodes.Conv_Ovf_U4 };
		...
		public static Conv_Ovf_I8_ Conv_Ovf_I8 => new Conv_Ovf_I8_() { opcode = OpCodes.Conv_Ovf_I8 };
		...
		public static Conv_Ovf_U8_ Conv_Ovf_U8 => new Conv_Ovf_U8_() { opcode = OpCodes.Conv_Ovf_U8 };
		...
		public static Refanyval_ Refanyval => new Refanyval_() { opcode = OpCodes.Refanyval };
		...
		public static Conv_Ovf_U_ Conv_Ovf_U => new Conv_Ovf_U_() { opcode = OpCodes.Conv_Ovf_U };
		...
		public static Add_Ovf_ Add_Ovf => new Add_Ovf_() { opcode = OpCodes.Add_Ovf };
		public class Add_Ovf_ : CodeMatch { public Add_Ovf_ this[object operand = null, string name = null] => (Add_Ovf_)Set(operand, name); }
		public static Add_Ovf_Un_ Add_Ovf_Un => new Add_Ovf_Un_() { opcode = OpCodes.Add_Ovf_Un };
		...
		public static Mul_Ovf_ Mul_Ovf => new Mul_Ovf_() { opcode = OpCodes.Mul_Ovf };
		public class Mul_Ovf_ : CodeMatch { public Mul_Ovf_ this[object operand = null, string name = null] => (Mul_Ovf_)Set(operand, name); }
		public static Mul_Ovf_Un_ Mul_Ovf_Un => new Mul_Ovf_Un_() { opcode = OpCodes.Mul_Ovf_Un };
		...
		public static Sub_Ovf_ Sub_Ovf => new Sub_Ovf_() { opcode = OpCodes.Sub_Ovf };
		public class Sub_Ovf_ : CodeMatch { public Sub_Ovf_ this[object operand = null, string name = null] => (Sub_Ovf_)Set(operand, name); }
		public static Sub_Ovf_Un_ Sub_Ovf_Un => new Sub_Ovf_Un_() { opcode = OpCodes.Sub_Ovf_Un };
		...
		public static Endfinally_ Endfinally => new Endfinally_() { opcode = OpCodes.Endfinally };
		...
		public static Unaligned_ Unaligned => new Unaligned_() { opcode = OpCodes.Unaligned };
		...
		public static Readonly_ Readonly => new Readonly_() { opcode = OpCodes.Readonly };
